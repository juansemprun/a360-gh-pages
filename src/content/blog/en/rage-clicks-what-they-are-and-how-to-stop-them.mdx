...
published: 2023-3-21
readingTime: 6
image: '@blog-assets/rage-clicks-what-they-are-and-how-to-stop-them/rage-clicks.webp'
metaDesc: The phenomenon where clicking on buttons or links that appear functional yields no meaningful result is called a rage click. Specifically, rage clicks occur when links fail to work, lead to 404 pages, take too long to load to be usable, or cause the site to crash.
tags:
  - ux
---
...
import RageClicksImage from '@blog-assets/rage-clicks-what-they-are-and-how-to-stop-them/rage-clicks-1.webp';
...
<Image src={RageClicksImage} alt="a group of young professionals looks at a computer screen" />
Usability testing can give a complete picture of users’ click events. During a usability test, UX
researchers observe people using a website in real-time. Researchers also identify user behavior by
asking detailed questions and listening to what users say while interacting with a website. In
addition to uncovering where people rage click on a site, usability testing uncovers why.
