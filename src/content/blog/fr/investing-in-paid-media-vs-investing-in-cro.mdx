...
published: 2023-3-07
readingTime: 5
image: '@blog-assets/investing-in-paid-media-vs-investing-in-cro/paid-ads-vs-cro.webp'
...
import PaidAdsVsCroImage from '@blog-assets/investing-in-paid-media-vs-investing-in-cro/paid-ads-vs-cro-1.webp';
...
<Image
  src={PaidAdsVsCroImage}
  alt="vector image of a laptop screen with different webpage layouts"
  width={800}
  height={450}
/>
CRO is the process of evaluating and making changes to your website that reduce barriers to
purchase.
